...
export const SCHEDULES = [
  ...
  {id:2, group_id:47, group_title:"Prof.", day:"2019-05-24T00:00:00.000000", time:"03:09:16"},
  {id:3, group_id:37, group_title:"Prof.", day:"2019-05-24T00:00:00.000000", time:"17:30:53"},
  {id:4, group_id:20, group_title:"Prof.", day:"2019-05-24T00:00:00.000000", time:"10:53:15"},
  {id:5, group_id:31, group_title:"Prof.", day:"2019-05-24T00:00:00.000000", time:"04:31:14"},
  {id:6, group_id:14, group_title:"Prof.", day:"2019-05-24T00:00:00.000000", time:"06:25:03"},
  {id:7, group_id:33, group_title:"Prof." , day:"2019-05-24T00:00:00.000000", time:"22:14:00"},
  {id:8, group_id:10, group_title:"Dr.", day:"2019-05-24T00:00:00.000000", time:"12:54:05"},
  {id:9, group_id:9, group_title:"Dr.", day:"2019-05-24T00:00:00.000000", time:"04:13:28"},
  ...
  {id:24, group_id:37, group_title:"Prof.",day:"2019-05-24T00:00:00.000000Z",time:"21:04:04"},
  {id:25, group_id:5, group_title:"Mr.",day:"2019-05-24T00:00:00.000000Z",time:"05:59:06"},
...
export class ScheduleMock {
  ...
  visit: boolean = false;
  schedules: Schedule[] = Object.assign([], SCHEDULES);
  ...
  updateSchedule(schedule: Schedule): Observable<any> {
    console.log(this.schedules[1].time);
    this.schedules = this.schedules.map(_schedule => (_schedule.id === schedule.id) ? schedule : _schedule );
    console.log(this.schedules[1].time);
    return of (true);
  }
  ...
  getSchedule(id: number): Observable<Schedule> {
    ...
    let schedule = this.schedules.filter((schedule => schedule.id === id));

    return of(schedule[0]);
  }
}
